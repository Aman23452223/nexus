...
REGISTRY = {
    ...
    "computer.open": ToolSpec("computer.open", "computer", RiskClass.REVERSIBLE, "app window observed on screen"),
    "computer.screenshot": ToolSpec("computer.screenshot", "computer", RiskClass.READ, "screenshot saved"),
